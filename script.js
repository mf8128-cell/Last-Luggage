...
const scenario = [
    { type: "saki", text: "はじめまして。突然のメッセージ、すみません。", wait: 5000 },
    { type: "saki", text: "3年前にいなくなった兄の件で、どうしてもお力をお借りしたくて連絡しました。ある方から、${userName}さんならこの日記を読み解けるかもしれないと伺って……。"", wait: 10000 },
    { type: "talk", text: "協力していただけるならメッセージ下さい！", wait: 5000 },
    { type: "saki", text: "返信ありがとうございます！ ", wait: 5000 },
    { type: "saki", text: "数日前、3年前に失踪した兄の当時の手荷物が落とし物センター経由でうちへ届きました。", wait: 10000 },
    { type: "saki", text: "中には使い込まれたノートが一冊入ってましたが、私には何のことが書かれているのか全く分かりませんでした……。", wait: 10000 },
    ...
    { type: "saki", text: "次は5月19日。私たちがお母さんのために鶴を折った話が書いてある……。", wait: 10000 },
    ...
    { type: "saki", text: "お兄ちゃん、お母さんの入院中もずっと鶴を折ってくれてたんです。", wait: 10000 },
    { type: "saki", text: "一番たくさん折ってたのがお兄ちゃんだったっけ。", wait: 10000 },
    { type: "saki", text: "でも『心の中の争い』なんて……お兄ちゃん、ずっと一人で何かと戦ってたの？", wait: 10000 },
    { type: "saki", text: "次の日記は8月31日。……あの日、私もこの『青い月』を見てた。" , wait: 10000},
    { type: "saki", text: "でもこの月自体は全国的に見れたみたいだし……${userName}さん、詳しい場所に心当たりはありますか？", wait: 10000 },
    {
        type: "quest",
        id: 3,
        img: "diary3.jpg",
    ...
    { type: "saki", text: "${userName}さん、ここね、私が小さい頃に迷子になった場所なの。", wait: 10000 },
    { type: "saki", text: "真っ暗で怖くて泣いてた私を、お兄ちゃんが見つけてくれたんだ。「もう大丈夫だよ」って。", wait: 10000},
    ...
    { type: "saki", text: "私がずっとマリオのグッズ欲しいって言ってたから、内緒で買いに行ってくれたんだね。", wait: 10000 },
    ...
    { type: "saki", text: "今、市内の療養施設に身元不明で預けられている男性がいるって。", wait: 10000 },
        { type: "saki", text: "今から行ってくる！", wait: 7000 },
    { type: "saki", text: "本当にありがとう。${userName}さんがいなかったら、私、お兄ちゃんの想いに一生気づけなかった。……また、落ち着いたら連絡するね！", wait: 10000 },
